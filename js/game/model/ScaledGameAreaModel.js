...
define( function( require ) {
   ...
   */
  function ScaledGameAreaModel( isLevelDebug ) {
  ...
  areaModelCommon.register( 'ScaledGameAreaModel', ScaledGameAreaModel );

  return inherit( GameAreaModel, ScaledGameAreaModel );
} );
